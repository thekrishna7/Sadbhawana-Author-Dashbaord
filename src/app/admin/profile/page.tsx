    ...
    <div className="space-y-6 max-w-2xl mx-auto animate-fade-in">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100 flex items-center gap-2.5">
          <User className="w-7 h-7 text-blue-600" /> Admin Profile & Security
        </h1>
        <p className="text-sm text-slate-500">Update admin contact info, photo, and system password.</p>
      </div>
      ...
      <div className="p-6 md:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
        <form onSubmit={handleSaveProfile} className="space-y-6">
          ...
          >
            <Save className="w-4 h-4" /> {saving ? 'Saving...' : 'Update Admin Profile'}
          </button>
        </form>
      </div>
    </div>
