    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-slate-100 flex items-center gap-2.5">
            <Bell className="w-7 h-7 text-blue-600" /> Notifications Center
            {unreadCount > 0 && (
          ...
          <p className="text-sm text-slate-500">Realtime notifications for book assignments, file uploads, and admin reviews.</p>
        </div>
          ...
          <div className="flex items-center gap-2.5">
            {unreadCount > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-blue-50 dark:bg-blue-950/60 hover:bg-blue-100 dark:hover:bg-blue-900/60 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800 text-xs font-semibold transition-colors"
              >
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
          ...
          <p className="text-xs text-slate-500 mt-1">You're up to date!</p>
        </div>
      ) : (
            ...
            <div
              ...
              className={`p-4 rounded-2xl border transition-all flex items-start gap-4 cursor-pointer group ${
                n.read
                  ...
                  : 'bg-blue-50/70 dark:bg-blue-950/50 border-blue-200 dark:border-blue-800 shadow-sm hover:shadow-md'
              }`}
            >
              <div
